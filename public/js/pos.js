...
// Update the datetimepicker's view to display the Nepali date
$('#transaction_date').data('DateTimePicker').date(nepaliDate);
...
// Convert the initial selected date to Nepali
var nepaliDate = moment(selectedDate); // Convert to Moment.js object

// Update the datetimepicker's view to display the Nepali date
$('#transaction_date').data('DateTimePicker').date(selectedDate);

// Convert the Nepali date to AD format
var addate = moment(nepaliDate);
...
function reset_pos_form(){
    ...
    if ($('#transaction_date_ad').length > 0) {
...
// Get the initial selected date
var selectedDate = $('#expense_transaction_date').data('date');

// Convert the initial selected date to Nepali
var nepaliDate = moment(convertToNepali(selectedDate)); // Convert to Moment.js object

// Update the datetimepicker's view to display the Nepali date
$('#expense_transaction_date').data('DateTimePicker').date(nepaliDate);

// Convert the Nepali date to AD format
var addate = moment(convertToAD(nepaliDate));

// Update the input field's value to reflect the Nepali date
$('#expense_transaction_date').val(nepaliDate.format('MM/DD/YYYY HH:mm'));

// Update the hidden input field 'expense_transaction_date_ad' with the AD date
$('#expense_transaction_date_ad').val(addate.format('YYYY-MM-DD HH:mm:ss'));
}
else{
...
// Update the datetimepicker's view to display the Nepali date
$('#expense_transaction_date').data('DateTimePicker').date(selectedDate);
