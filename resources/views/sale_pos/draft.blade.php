...
$(document).ready( function(){
    // Define the convertToAD function
    ...
    // Date range picker for sell list filter
    $('#sell_list_filter_date_range').daterangepicker(
        dateRangeSettings,
        function(start, end) {
            // Fetch the year format, assuming an element exists to hold the value
            var yearFormat = $('#year-format').val(); // You need to have this element in your HTML
            if (yearFormat === 'BS') {
        ...
        ajax: {
            ...
            data: function(d) {
                if ($('#sell_list_filter_date_range').val()) {
                    ...
                    var yearFormat = $('#year-format').val(); // Ensure this element exists and is populated
                    if (yearFormat === 'BS') {
