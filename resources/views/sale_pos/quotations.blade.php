...
$(document).ready( function(){
    ...
    $('#sell_list_filter_date_range').daterangepicker(
        dateRangeSettings,
        function (start, end) {
            // Fetch the current year format from a supposed page element
            // This requires an element that holds the year format value (BS or AD)
            ...
            $('#sell_list_filter_date_range').val(start + ' ~ ' + end);
        ...
        ajax: {
            ...
            data: function (d) {
                if($('#sell_list_filter_date_range').val()) {
                    ...
                    var yearFormat = $('#year-format').val(); // Assume this element exists and holds the current year format
                    if (yearFormat === 'BS') {
