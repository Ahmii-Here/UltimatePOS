	...
	<div class="{{$col_class}}">
		<div class="form-group">
			...
			<div class="input-group">
              ...
              {!! Form::hidden("payment[$row_index][paid_on_ad]", isset($payment_line['paid_on_ad']) ? @format_datetime($payment_line['paid_on']) : @format_datetime('now'), ['class' => 'form-control paid_on_ad', 'readonly']); !!}
            </div>
		</div>
	</div>
	@endif
