...
<script>
	// Function to reload the page after printing
function reloadPageAfterPrint() {
    window.location.reload(true); // Reload the page
}

// Listen for the 'afterprint' event and call the reload function
window.addEventListener('afterprint', reloadPageAfterPrint);
