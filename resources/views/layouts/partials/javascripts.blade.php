...
@php
$yearFormat = \App\Business::where('id', Session::get('user.business_id'))->value('year_format');
@endphp

<input type="hidden" id="year-format" value="{{ $yearFormat }}">
...
<script>
    ...
    console.log(datepicker_date_format)
    console.log(moment_date_format)
    console.log(moment_time_format)
