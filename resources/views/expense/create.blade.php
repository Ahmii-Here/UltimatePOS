				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::hidden('transaction_date', @format_datetime('now'), ['class' => 'form-control', 'readonly', 'required', 'id' => 'expense_transaction_date']); !!}
                            {!! Form::hidden('expense_transaction_date_ad', @format_datetime('now'), ['class' => 'form-control', 'readonly', 'required', 'id' => 'expense_transaction_date']); !!}
						</div>
					</div>
				</div>
				<div class="col-sm-4">
