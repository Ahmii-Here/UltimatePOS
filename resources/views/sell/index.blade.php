...
<script type="text/javascript">
      ...
      function convertToAD(nepaliDate) {
        ...
        const momentDate = moment(nepaliDate, 'YYYY-MM-DD'); // Ensure the format matches your input
...
$(document).ready( function(){
    //Date range as a button
     $('#sell_list_filter_date_range').daterangepicker(
        dateRangeSettings,
        function (start, end) {
            var yearFormat = $('#year-format').val(); // Assuming this is where the year format is stored
            if (yearFormat === 'BS') {
        ...
        "ajax": {
            ...
            "data": function ( d ) {
                if($('#sell_list_filter_date_range').val()) {
                    ...
                    var yearFormat = $('#year-format').val(); // Fetch the year format again here
                    if (yearFormat == 'BS') {
