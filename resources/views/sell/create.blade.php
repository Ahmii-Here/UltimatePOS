				...
				<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::hidden('transaction_date_ad', $default_datetime, ['id' => 'transaction_date_ad']); !!}
...
// var selectedDate = $('.paid_on').data('date');
...
// $('.paid_on').data('DateTimePicker').date(nepaliDate);
...
// $('.paid_on').val(addate.format('MM/DD/YYYY HH:mm'));

// // Update the hidden input field .paid_on_ad' with the AD date
// $('.paid_on_ad').val(addate.format('YYYY-MM-DD HH:mm:ss'));
...
// // Update the datetimepicker's view to display the Nepali date
// $('.paid_on').data('DateTimePicker').date(selectedDate);

// // Convert the Nepali date to AD format
// var addate = moment(nepaliDate);

// // Update the input field's value to reflect the Nepali date
// $('.paid_on').val(nepaliDate.format('MM/DD/YYYY HH:mm'));
