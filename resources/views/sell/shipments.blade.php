...
$(document).ready( function(){
    ...
    $('#sell_list_filter_date_range').daterangepicker(
        dateRangeSettings,
        function(start, end) {
            // Assuming an input element with ID 'year-format' holding the current year format (BS or AD)
            var yearFormat = $('#year-format').val(); // Ensure you have an input/select with this ID
            if (yearFormat === 'BS') {
        ...
        "ajax": {
            ...
            "data": function(d) {
                if($('#sell_list_filter_date_range').val()) {
                    ...
                    var yearFormat = $('#year-format').val(); // Make sure to fetch the current year format
                    if (yearFormat === 'BS') {
