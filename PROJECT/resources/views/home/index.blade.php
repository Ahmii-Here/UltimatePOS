...
<section class="content-header content-header-custom">
   <div class="row">
      <div class="col-md-5 col-xs-12 title-side">
        <div>
            <h1 class="text-primary text-blue">{{ __('home.welcome_message', ['name' => Session::get('user.first_name')]) }}
                </h1>
                <h3>Business inventory and analytics</h3>
            </div>
      ...
      <div class="col-md-7 col-xs-12 btn-group-box">
         <div class="form-group">
            <!-- <div class="input-group">
               <button type="button" class="btn filter-white-btn filter-btn" id="dashboard_business_location_filter">
               <span>
               Select Location
               </span>
            ...
            <button type="button" class="btn btn-primary  btn-tax">
            <span>Over all tax</span>
            <span>Rs {{ $overall_tax }}</span>
            </button>
            
         </div>
         <div class="btn-group" role="group" aria-label="Basic mixed styles example">
            <button type="button" class="btn group-btn btn-info">
            <span>User</span>
            <span>{{ $users }}</span>
            </button>
            <button type="button" class="btn group-btn btn-warning">
            <span>Customer</span>
            <span>{{ $customers }}</span>
            </button>
            <button type="button" class="btn group-btn btn-danger">
            <span>Products</span>
            <span>{{ $products }}</span>
            </button>
            <button type="button" class="btn group-btn btn-success">
            <span>Suppliers</span>
            <span>{{ $suppliers }}</span>
            </button>
         </div>
         <div class="form-group">
            <div class="input-group">
               <button type="button" class="btn btn-primary filter-btn" id="dashboard_date_filter">
               <span>
...
<!-- Main content -->
<section class="content content-custom no-print dashboard">
    <br>
        ...
        @if($is_admin)
           ...
           <div class="row">
               <div class="col-sm-12">
                    ...
                    <div class="row">
                    <!-- /.col -->
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style primary">
                       ...
                       <div class="info-box-content">
                        ...
                        <i class="fas fa-chart-pie big-icon"></i>
                        <!-- /.info-box-content -->
                   </div>
                  <!-- /.info-box -->
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style info">
                        <div class="info-box-content">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style success">
                        ...
                        <i class="fas fa-shopping-bag big-icon"></i>
                        <!-- /.info-box-content -->
                    </div>
                  <!-- /.info-box -->
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style danger">
                        
                        <div class="info-box-content">
                            <span class="info-box-text">{{ __('lang_v1.total_invoice') }}</span>
                            <span class="info-box-number total_invoice"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                       
                            <i class="fas fa-minus-circle big-icon"></i>
    	    ...
    	    <!-- /.col -->
          	...
          	<div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style simple-box">
                
                       <div class="info-box-content">
                       <i class="ion ion-cash"></i>    
                       <span class="info-box-text">{{ __('lang_v1.invoice_due')}}</span>
                        </div>
                        <span class="info-box-number invoice_due"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        <!-- /.info-box-content -->
                   </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style simple-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-text">{{ __('lang_v1.expense_due') }}</span>
                        </div>
                        <span class="info-box-number expense_due"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style simple-box">
                        ...
                        <span class="info-box-number total_sr"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 col-custom">
                   ...
                   <div class="info-box info-box-new-style simple-box">
                       <div class="info-box-content">
                       <i class="ion ion-cash"></i>    
                       <span class="info-box-text">{{ __('lang_v1.total_sell_return_paid')}}</span>
                        </div>
                        <span class="info-box-number total_srp"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        <!-- /.info-box-content -->
                   </div>
                   <!-- /.info-box -->
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style simple-box">
                       ...
                       <i class="fas fa-check-circle"></i>
                        ...
                        <span class="info-box-number total_pr"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        <!-- <span class="info-box-icon bg-yellow">
                            <i class="fa fa-dollar"></i>
                        </span> -->
                        <!-- /.info-box-content -->
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style simple-box">
                        <div class="info-box-content">
                            <i class="fas fa-undo-alt"></i>
                            <span class="info-box-text">{{ __('lang_v1.total_purchase_return_paid')}}</span>
                        </div>
                        <span class="info-box-number total_prp"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        <!-- <span class="info-box-icon bg-red text-white">
                        </span> -->
                        <!-- /.info-box-content -->
                    </div>
...
<!-- <div class="cols-xxl-4 col-md-4 col-12">
    <div class="card card-box chart-box">
        <div class="card-header">
            <h5>Top Sell Product</h5>
            <h5>View All</h5>
        </div>  
        <div class="card-body">
            <div id="chart"></div>
