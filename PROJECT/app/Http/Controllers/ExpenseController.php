...
class ExpenseController extends Controller
{
    ...
    public function index()
    {
        ...
        $business_id = request()->session()->get('user.business_id');
         ...
         // Retrieve year format from the Business model
         $yearFormat = Business::where('id', $business_id)->value('year_format');
        ...
        return view('expense.index')
            ->with(compact('categories', 'business_locations', 'users', 'contacts', 'sub_categories', 'yearFormat'));
