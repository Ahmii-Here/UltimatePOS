...
class TransactionUtil extends Util
{
    ...
    public function createExpense($request, $business_id, $user_id, $format_data = true)
    {
        ...
        if ($request->has('transaction_date')) {
            $transaction_data['transaction_date'] = $format_data ? $this->uf_date($transaction_data['expense_transaction_date_ad'], true) : $transaction_data['transaction_date'];
        } else {
