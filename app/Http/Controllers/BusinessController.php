...
class BusinessController extends Controller
{
    ...
    */
    ...
    public function getRegister()
    {
        ...
        $dates = [];
        for ($i = 1; $i <= 31; $i++) {
            $dates[sprintf('%02d', $i)] = sprintf('%02d', $i);
        }
        ...
        try {
            $validator = $request->validate(
                ...
                [
                    ...
                    'fy_start_date.required' => __('validation.required', ['attribute' => __('business.fy_start_date')]),
